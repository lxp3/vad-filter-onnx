...
class LinearResample {
  public:
    ...
    LinearResample(int32_t samp_rate_in_hz, int32_t samp_rate_out_hz, float filter_cutoff_hz,
                   int32_t num_zeros);
    ...
    void Resample(const float *input, int32_t input_dim, bool flush, std::vector<float> *output);
